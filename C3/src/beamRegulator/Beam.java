...
/**
 * Beam är den virtuella processen för bommen utan kula. Följande beskrivning
 * av processen har en insignal, en utsignal och ett tillstånd.
 * 
 * <pre>
 * Tillståndsvektor:
 *
 ...
 * </pre>
 * 
 * Det finns även en animering implementerad till denna virtuella process. För
 * att visa animering använd metoden getAnimationPanel i VirtualProcess och
 * lägg in panel i ett fönster (se exempel 2 i
 * <A HREF="../SimEnvironment/VirtualProcess.html">VirtualProcess</A>).
 * Uppdateringen av animeringen sker automatiskt med en animeringstråd i Vir
 * tualProcess.
 * <P>
 *
...
public class Beam extends VirtualProcess {
	 ...
	 *            process outputs
	 */
	public void draw(Graphics2D g2, JPanel jp, double[] state, double[] input, double[] output) {
		if (!init)
		...
		g2.draw(box);
		g2.rotate(-1 * output[0] * Math.PI / 40, 150, 115); // rotate the
															// following with
															// the beam angle
